...
#define SubMsg2_init_default                     {{{NULL}, NULL}, 0}
#define TopMsg_init_default                      {{{NULL}, NULL}, 0, _MSG_TYPE_MIN, SubMsg1_init_default, SubMsg2_init_default}
#define SubMsg1_init_zero                        {{{NULL}, NULL}, 0}
#define SubMsg2_init_zero                        {{{NULL}, NULL}, 0}
#define TopMsg_init_zero                         {{{NULL}, NULL}, 0, _MSG_TYPE_MIN, SubMsg1_init_zero, SubMsg2_init_zero}

/* Field tags (for use in manual encoding/decoding) */
#define SubMsg1_text_tag                         1
#define SubMsg1_val_tag                          2
#define SubMsg2_text_tag                         1
#define SubMsg2_val_tag                          2
...
X(a, STATIC, SINGULAR, MESSAGE, sub1, 40) \
X(a, STATIC, SINGULAR, MESSAGE, sub2, 50)
#define TopMsg_CALLBACK pb_default_field_callback
#define TopMsg_DEFAULT NULL
#define TopMsg_sub1_MSGTYPE SubMsg1
#define TopMsg_sub2_MSGTYPE SubMsg2
